...
async function retrieveRelevantContent(question: string, k: number) {
  try {
...
function mergeUnique(
  ...
  const map = new Map<string, (typeof existingDocs)[number]>();
...
const decomposeQuestionNode = async (state: typeof GraphState.State) => {
...
const planNextStepNode = async (state: typeof GraphState.State) => {
...
function afterPlan(state: typeof GraphState.State) {
